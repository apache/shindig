...
require 'src/social-api/GroupId.php';
require 'src/social-api/UserId.php';
require 'src/social-api/ResponseItem.php';
require 'src/social-api/RestfulCollection.php';
require 'src/social-api/RestRequestItem.php';
require 'src/social-api/OutputConverter.php';
