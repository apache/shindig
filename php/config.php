 ...
 */
$shindigConfig = array(
	// Plain text tokens are meant for the html / javascript samples not for hack-me-please type real-life-scenarios
	// Set both of these to false on anything resembling a live deployment
	'debug' => true, 
	...
	//WARNING: handlers is depreciated in the RESTful protocol, use people/activity and appdata service instead
