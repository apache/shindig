...
public class RenderModule extends AbstractModule {
  ...
  protected void configure() {
    ...
    Set<String> allowedTags = ImmutableSet.of("a", "abbr", "acronym", "area", "b", "bdo", "big", "blockquote",
    ...
    Set<String> allowedAttributes = ImmutableSet.of("abbr", "align", "alt", "axis", "bgcolor", "border",
