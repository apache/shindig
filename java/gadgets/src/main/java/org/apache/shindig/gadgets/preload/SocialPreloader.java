...
/**
 * Preloader for loading Preload data.
 */
public class SocialPreloader implements Preloader {
  ...
  @Inject
  public SocialPreloader(ContentFetcherFactory fetcher, ContainerConfig config) {
  ...
  public Collection<Callable<PreloadedData>> createPreloadTasks(GadgetContext context,
    ...
    if (view != null
      ...
      Map<String, Preload> httpPreloads = view.getSocialData().getHttpPreloads();
  ...
  private class SocialPreloadTask implements Callable<PreloadedData> {
    ...
    public PreloadedData call() throws Exception {
      ...
      return new SocialPreloadedData(data);
    }
  }
  ...
  private class SocialPreloadedData implements PreloadedData {
    private final Map<String, Object> data;

    public SocialPreloadedData(Map<String, Object> data) {
      this.data = data;
    }
