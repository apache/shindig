...
public abstract class AbstractActivityStreamsRestfulTests extends EasyMockTestCase {
  ...
  public void abstractActivityStreamsRestfulBefore() throws Exception {
    Injector injector = Guice.createInjector(new ActivityStreamsTestsGuiceModule());
